...
console.log("programmingIsCool is", typeof(programmingIsCool)); // boolean
console.log("clearancePrice is", typeof(clearancePrice));   // number
console.log("lifeTheUniverseAndEverything is", typeof(lifeTheUniverseAndEverything)); // number
console.log("theCruelestMonth is", typeof(theCruelestMonth)); // string